...
import { DepartmentsPageClient } from "@/components/master-data/departments-page-client"
import { findAllDepartments } from "@/repositories/department-repository"
...
export default async function DepartmentsPage({ params }: Props) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <DepartmentsPageClient initialDepartments={departments} />
    </div>
  )
}
